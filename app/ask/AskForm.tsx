    ...
    <>
      <form onSubmit={submit} className="mt-8">
        ...
        <button
          ...
          className="mt-4 rounded-sm bg-white px-6 py-2.5 text-[14px] font-semibold text-[var(--ds-bg)] hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
        >
          {running ? "Running…" : "Ask →"}
        </button>
      </form>
