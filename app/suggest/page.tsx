// /suggest — email-gated form for proposing investigations. We don't run on
      ...
      <section className="border-b border-[var(--ds-border)] bg-[var(--ds-bg)]">
        <div className="mx-auto max-w-[760px] px-6 py-16 md:px-8 md:py-20">
          ...
          <p className="mt-5 max-w-[58ch] text-[16px] leading-[1.65] text-[var(--ds-text-mute)]">
            We curate the public library by hand — high-effort, high-signal investigations on Texas civic data. Tell us what you'd want answered and we'll email you when (and if) it lands. No spam, no sales.
          </p>
